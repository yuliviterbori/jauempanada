...
function Item({
    ...
    const onSubmit = e => {
      e.preventDefault();
      onAddToOrderClick(product?._id, quantity);
    }
    ...
    <div className="card-body">
      ...
      style={{border: "none", backgroundColor: "white", borderRadius: "50%", position: "absolute", top: "10px", right: "10px",width: "35px", height: "35px"}}>
        { isFavorite ? (
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart text-brown" viewBox="0 0 16 16">
